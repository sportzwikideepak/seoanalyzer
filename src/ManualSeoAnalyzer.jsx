        ...
        <form onSubmit={(e) => e.preventDefault()} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', marginTop: '12px' }}>
            <button
              ...
              style={{ backgroundColor: '#4f46e5', color: '#fff', padding: '12px', border: 'none', borderRadius: '6px', fontWeight: '600', flex: 1 }}
              disabled={loading}
            >
              {loading && language === "en" ? "Analyzing..." : "Analyze in English"}
            </button>

            <button
              onClick={() => handleSubmit("hi")}
              style={{ backgroundColor: '#10b981', color: '#fff', padding: '12px', border: 'none', borderRadius: '6px', fontWeight: '600', flex: 1 }}
              disabled={loading}
            >
              {loading && language === "hi" ? "विश्लेषण हो रहा है..." : "Analyze in Hindi"}
            </button>
          </div>
        </form>
