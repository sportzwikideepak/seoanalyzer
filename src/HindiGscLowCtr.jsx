...
function HindiGscLowCtr() {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      console.error("❌ Failed to fetch Hindi low CTR reports:", err);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Low Click-Through Rate Fixes for Hindi Domain
        </p>
        <div
          style={{
            fontSize: "14px",
